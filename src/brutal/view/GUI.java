...
public class GUI extends JFrame {
	...
	public void initFenetre() {
		...
		Image img1 = new ImageIcon("src/brutal/view/ressources/maitre.png").getImage();
		...
		Image img2 = new ImageIcon("src/brutal/view/ressources/elite.png").getImage();
		...
		Image img3 = new ImageIcon("src/brutal/view/ressources/etudiant.png").getImage();
	...
	final class MonEcouteurEvenements implements ActionListener {
		private Map<String, IStudent> liste;
		private String key;

		public MonEcouteurEvenements(Map<String, IStudent> liste, String key) {
			this.liste = liste;
			this.key = key;
		}
		public void actionPerformed(ActionEvent e) {
